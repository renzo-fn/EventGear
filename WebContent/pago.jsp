...
<%
    ...
    String nombreCliente = (String) session.getAttribute("nombre_cliente");
...
<body>
  <div class="container">
    <h1>Panel de Pago</h1>
    <p>Bienvenido, <strong><%= nombreCliente != null ? nombreCliente : "Cliente" %></strong></p>
    ...
    <br><br>
    <a href="catalogo.jsp">
      <button type="button">Volver al catálogo</button>
    </a>
    <a href="logout.jsp" style="margin-left: 20px;">
